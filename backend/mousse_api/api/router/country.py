...
from mousse_api.api.schemata.country import CountryBase
...
@router.get('/codes/{codes}', summary="Get a GeoJSON of selected countries")
async def geojson(codes: str, session: AsyncSession = Depends(get_session)):
    query = select(
